...
## #6. GE: Theatre (Performance, AI & Design)

## Scripted play
- Exploring Characters/ Character development
- Understanding the Scenes
- Discuss characters' motivations, relationships, and objectives.
- character-building exercise (improvised)
- Blocking charcters, space
- Stage positioning, movement, and visual composition.
- Character choices affect movement on stage.
- Scene Performances and Feedback

## La Ronde
- Character Blocking 
- Practical Exercise: "La Ronde" 
- Scene Performances and Feedback
